...
extern "C" {
    ...
    WHISPER_API struct whisper_context * whisper_init_from_file(const char * path_model, const int verbose);
    ...
    WHISPER_API struct whisper_context * whisper_init_no_state(struct whisper_model_loader * loader, const int verbose);

    WHISPER_API struct whisper_state * whisper_init_state(struct whisper_context * ctx, const int verbose);
